      ...
      <div className="mt-2 mb-6">
       ...
       <b> Please read the instructions carefully. There will be a quiz. You cannot continue to the game if you do not pass the quiz.</b> <br/>
        <br/>        
          ...
          While each individual message is only sent to and received by one person, everyone is talking to multiple people. At the current stage of this experiment, you are <b>not exchanging messages</b>, but leaving a message for someone else to read.<br />
        ...
        <p className="text-sm text-gray-700">
          <br/>Everyone on the team has a single  <b>window</b> they're looking out of, which you can see on the left of the image below. At the current stage of this experiment, you will only be getting <b>one set of critters</b>- the page reloading does not signal a new day (for now!) 
          ...
          <br/><b>If, by the end of the game, all of you are in agreement as to the ratio of critters in the neighborhood, you will receive a bonus. The base pay for this experiment is 15$/hr. </b>
