...
d.guesses <- d.guesses %>%
  ...
  mutate(newScore = wisError/AvgPercent)
...
```{r}
ggplot(d.MLE, aes(x = idx, y = wisError, color = as.factor(rounded_outlier))) +
  geom_point() +
