...
d.guesses.collapsed <- d.guesses %>%
  ...
  mutate(treatmentName = ifelse(treatmentName %in% c('0_experiment1_exploratory-0.7', '0_experiment1_exploratory-0.3'),
                                '0_experiment1_exploratory-unidirectional', treatmentName)) %>%
