...
\
Get entropy, representation, replications\
—-\
total information = nCrittersGame\
conditions = treatment\
error = error\
\
entropy = crittersPercentage\
\
representation = (avg per game abs(mlePlayer - mleGame))\
\
\
modality = condition
...
color = number of games/participants\
representation = in quartiles - use forcats <https://forcats.tidyverse.org/>\
cut interval - optimizes the bins <https://ggplot2.tidyverse.org/reference/cut_interval.html>\
\
entropy as a seperate cross set of graphs\
y rep x entropy\
make entropy across game\
do entropy as a real entropy calc instead
