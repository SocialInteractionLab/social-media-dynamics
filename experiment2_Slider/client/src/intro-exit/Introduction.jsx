    ...
    <div className="mt-3 sm:mt-5 p-20">
      ...
      <div className="mt-2 mb-6">
       ...
       <b> Please read the instructions carefully. There will be a quiz. You cannot continue to the game if you do not pass the quiz.</b> <br/>
        <br/>        
          In this game, you are part of a team of 6-8 players. You are all <b>neighbors </b>in the same area, using an app to talk to each other. 
          While each individual message is only sent to and received by one person, everyone is talking to multiple people. At the current stage of this experiment, you are not exchanging messages, but <b>changing a slider for someone else to see.</b><br />
        ...
        <p className="text-sm text-gray-700">
		 ...
		 You're going to share what you think with your neighbor using the <b>slider</b>, seen to the right of the image.<br/> <br/>

		 Following this, you will see someone else's slider. <br/> <br/> 
